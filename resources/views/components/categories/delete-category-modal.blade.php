...
<div 
    x-data="deleteModalData('{{ $modalId }}')" 
    ...
    <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 relative z-10 w-full max-w-md"
            ...
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold" x-text="deleteModalTitle"></h2>
...
<script>
    function deleteModalData(modalId) {
        return {
            open: false,
            id: '',
            name: '',
            deleteModalTitle: 'Eliminar Categoría',
            handleOpenModal(detail) {
                if (detail.modalId === modalId) {
                    this.open = true;
                    this.deleteModalTitle = 'Eliminar Categoría';
