<x-app-layout>
    <div class="container mx-auto py-8">
        ...
        <x-reusable-table :columns="[
            ...
            <x-slot name="rowActions">
                <div class="flex flex-row justify-between">
                    <span x-data @click="$dispatch('open-modal', { modalId: 'createStockModal', stock: row })"
                    ...
                    <span x-data @click="$dispatch('open-modal', { modalId: 'deleteStockModal', stock: row })"
                        class="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <div class="flex justify-center mt-4">
            <x-reusable-button x-data @click="$dispatch('open-modal', { modalId: 'createStockModal'})"
                btnText="Agregar Producto a Stock" />
        </div>|
        <x-stocks.create-stock-modal modalId="createStockModal" :products="$products" />
        <x-stocks.delete-stock-modal modalId="deleteStockModal" />
    </div>
</x-app-layout>
