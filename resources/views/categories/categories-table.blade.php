        ...
        return [
            ...
            <x-slot name="rowActions">
                <div class="flex flex-row justify-between">
                    <span x-data @click="$dispatch('open-modal', { modalId: 'createCategoryModal', category: row })" class="cursor-pointer">
                    ...
                    <span  x-data @click="$dispatch('open-modal', { modalId: 'deleteCategoryModal', category: row })" class="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
